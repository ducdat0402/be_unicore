...
{
    public class FaceAuthLogRepository : BaseRepository<FaceAuthLog>, IFaceAuthLogRepository
    {
        public FaceAuthLogRepository(UniCoreDbContext context) : base(context) { }
